...
import com.busquedaCandidato.candidato.mapper.IMapperRolIDRequest;
import com.busquedaCandidato.candidato.mapper.IMapperRolIDResponse;
...
public class RoleIDService {
    ...
    private final IMapperRolIDResponse mapperRolIDResponse;
    private final IMapperRolIDRequest mapperRolIDRequest;
     ...
     *         contrario vacío.
     */
    public Optional<RolIDResponseDto> getRolID(Long id) {
     ...
     */
    public List<RolIDResponseDto> getAllJRoleID() {
     ...
     */
    public RolIDResponseDto saveRolID(RolIDRequestDto rolIDRequestDto) {
     ...
     */
    public Optional<RolIDResponseDto> updateRolID(Long id, RolIDRequestDto rolIDRequestDto) {
        return roleIDRepository.findById(id)
                .map(existing -> {
