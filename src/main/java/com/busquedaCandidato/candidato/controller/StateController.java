...
public class StateController {
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "State found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = StateResponseDto.class))),
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "All state returned", content = @Content(mediaType = "application/json", array = @ArraySchema(schema = @Schema(implementation = StateResponseDto.class)))),
        ...
        @ApiResponses(value = {
                        ...
                        @ApiResponse(responseCode = "400", description = "State invalid request", content = @Content)
        })
        @PostMapping("/")
        ...
        @PutMapping("/{id}")
        public ResponseEntity<StateResponseDto> updateState(@Valid @PathVariable Long id,
